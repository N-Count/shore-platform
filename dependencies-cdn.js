...
//   { name: 'echarts', library: 'echarts', js: 'https://cdn.jsdelivr.net/npm/echarts@4.7.0/dist/echarts.min.js', css: '' }
// ]

module.exports = [
  // { name: 'vue', library: 'Vue', js: './lib/vue@2.6.11/dist/vue.js', css: '' },
  // { name: 'vue-i18n', library: 'VueI18n', js: './lib/vue-i18n@8.15.1/dist/vue-i18n.js', css: '' },
  // { name: 'vue-router', library: 'VueRouter', js: './lib/vue-router@3.1.3.min.js', css: '' },
  // { name: 'vuex', library: 'Vuex', js: './lib/vuex@3.1.2.min.js', css: '' },
  // { name: 'axios', library: 'axios', js: './lib/axios@0.19.0.min.js', css: '' },
  // { name: 'better-scroll', library: 'BScroll', js: './lib/better-scroll@1.15.2.min.js', css: '' },
  // { name: 'element-ui', library: 'ELEMENT', js: './lib/element-ui-2.13.0/lib/index.js', css: './lib/element-ui-2.13.0/lib/theme-chalk/index.css' },
  // { name: 'mockjs', library: 'Mock', js: './lib/mockjs@1.1.0.min.js', css: '' },
  // { name: 'lodash', library: '_', js: './lib/lodash@4.17.15.min.js', css: '' },
  // { name: 'ua-parser-js', library: 'UAParser', js: './lib/ua-parser-js@0.7.20.min.js', css: '' },
  // { name: 'js-cookie', library: 'Cookies', js: './lib/js-cookie@2.2.1.min.js', css: '' },
  // { name: 'nprogress', library: 'NProgress', js: './lib/nprogress@0.2.0.min.js', css: './lib/nprogress@0.2.0.css' },
  // { name: 'dayjs', library: 'dayjs', js: './lib/dayjs@1.8.17.min.js', css: '' },
  // { name: 'fuse.js', library: 'Fuse', js: './lib/fuse.js@3.4.6.min.js', css: '' },
  // { name: 'hotkeys-js', library: 'hotkeys', js: './lib/hotkeys-js@3.7.3.js', css: '' },
  // { name: 'qs', library: 'Qs', js: './lib/qs@6.9.1.js', css: '' },
  // { name: 'lowdb', library: 'low', js: './lib/lowdb@1.0.0.min.js', css: '' },
  // { name: 'lowdb/adapters/LocalStorage', library: 'LocalStorage', js: './lib/lowdb@1.0.0-LocalStorage.min.js', css: '' },
  // { name: 'screenfull', library: 'screenfull', js: './lib/screenfull@5.0.0.min.js', css: '' },
  // { name: 'sortablejs', library: 'Sortable', js: './lib/sortablejs@1.10.1.min.js', css: '' }
  // { name: 'echarts', library: 'echarts', js: './lib/echarts@4.7.0.min.js', css: '' }
]
